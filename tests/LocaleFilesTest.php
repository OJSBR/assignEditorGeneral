...
/**
 * @file plugins/generic/assignEditorGeneral/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends TestCase
{
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.generic\.assignEditorGeneral\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
