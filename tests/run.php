...
/**
 * @file plugins/generic/assignEditorGeneral/tests/run.php
 *
...
define('ASSIGNEDITORGENERAL_STANDALONE_TESTS', true);
...
foreach ($files as $file) {
    require_once $file;
    $class = 'APP\plugins\generic\assignEditorGeneral\tests\\' . basename($file, '.php');
